...
export default class MyCollectLaugh extends Component {
        ...
        header: ({ navigation }) => {
            return (
                <ImageBackground style={{ ...header }} source={require('../assets/backgroundImageHeader.png')} resizeMode='cover'>
                    ...
                    <Text style={{ fontSize: 17, textAlign: 'center', fontWeight: '300', lineHeight: 43.7, color: '#fff' }}>本地收藏的看故事</Text>
                    <TouchableOpacity activeOpacity={1} onPress={() => {
                    }}>
    ...
    removeStorage = (item) => {
        ...
        READ_CACHE(storageKeys.localMp4, (res) => {
            ...
            WRITE_CACHE(storageKeys.localMp4, res);
            ...
            <TouchableOpacity activeOpacity={1} onPress={() => {
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', height: 50, backgroundColor: 'white', justifyContent: 'space-between' }}>
                    <View style={{ marginLeft: 20, flexDirection: 'row', alignItems: 'center' }}>
                        <MaterialIcons name="ondemand-video" size={22} color={Color.FontColor} />
                    ...
                    <TouchableOpacity activeOpacity={1}
                        ...
                        <Ionicon name="ios-remove-circle-outline" size={22} color={'red'} style={{ marginRight: 20 }} />
                    </TouchableOpacity>
                </View>
            </TouchableOpacity>
        )
